<?php
    ...
    require_once realpath(__DIR__ . '/Helper/Singleton.php');

    if (!class_exists('WBL_Modules_Helper_Singleton', false)) {
        spl_autoload_call('WBL_Modules_Helper_Singleton');
    } // if
    ...
    if ((version_compare($sSysVersionForLoader, '4.7.0', '>=')) && ((version_compare($sSysVersionForLoader, '4.7.6', '<')) ||
        (version_compare($sSysVersionForLoader, '5.0.6', '<')))) {
